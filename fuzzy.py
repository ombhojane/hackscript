...
rule2 = ctrl.Rule(traffic_density['medium'] or pedestrian_density['medium'], signal_duration['medium'])
rule3 = ctrl.Rule(traffic_density['high'] or pedestrian_density['high'], signal_duration['long'])
signal_ctrl = ctrl.ControlSystem([rule1, rule2, rule3])
signal_sim = ctrl.ControlSystemSimulation(signal_ctrl)
traffic_sim_value = 50
pedestrian_sim_value = 80
